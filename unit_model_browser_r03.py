        ...
        with open(filepath, 'r', encoding='utf-8', errors='replace') as f:
            ...
            for row in reader:
                ...
                try:
                    ...
                    units.append(SimpleUnit(unit_id, name, pic, u_class, category))
                except ValueError:
                    continue
    except Exception as e:
...
class UnitModelBrowser(QMainWindow):
    ...
    def setup_browser_tab(self):
        ...
        info_grid.addWidget(QLabel("Mesh File:"), 4, 0); info_grid.addWidget(self.lbl_mesh_file, 4, 1)
    ...
    def filter_list(self):
        ...
        for u in self.units:
            if cat != "all" and u.category != cat: continue
            if txt and (txt not in u.name.lower() and txt not in str(u.id)): continue
        ...
        self.lbl_count.setText(f"{count} units loaded")
    ...
    def launch_viewer(self):
        ...
        try:
            cwd = self.selected_mesh_path.parent
            # DO NOT KILL previous process. Simply start new one and track it.
            proc = subprocess.Popen([viewer, str(self.selected_mesh_path)], cwd=str(cwd))
